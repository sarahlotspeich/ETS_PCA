...
p = c("https://raw.githubusercontent.com/sarahlotspeich/ETS_PCA/refs/heads/main/Sim-Data/correlated_errors_10_11422.csv", 
      "https://raw.githubusercontent.com/sarahlotspeich/ETS_PCA/refs/heads/main/Sim-Data/correlated_errors_1_11422.csv", 
...
ggsave(plot = error_var_plot, 
	   filename = "~/Documents/ETS_PCA/Plots/Correlated_Error_Variance.pdf", 
       device = "pdf", 
       width = 8, 
       height = 10)
...
ggsave(plot = error_var_barbell_plot, 
	   filename = "~/Documents/ETS_PCA/Plots/Correlated_Error_Variance_Barbell.pdf", 
       device = "pdf", 
       width = 8, 
       height = 5)
...
ggsave(plot = error_var_bar_plot, 
       filename = "~/Documents/ETS_PCA/Plots/Correlated_Error_Variance_Bar.pdf", 
       device = "pdf", 
       width = 8, 
       height = 5)
